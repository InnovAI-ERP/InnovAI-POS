...
const invoiceSchema = z.object({
  ...
  otrosCargos: z.array(z.object({
    ...
    detalle: z.string(),
    porcentaje: z.number().min(0).optional(),
    monto: z.number().min(0, "El monto debe ser mayor o igual a cero"),
...
const InvoiceCreate = () => {
  ...
  const defaultValues: InvoiceFormData = {
    ...
    otrosCargos: [], // Inicialmente vacío
  ...
  const handleAddOtroCargo = () => {
    appendOtroCargo({
      id: otrosCargosFields.length + 1,
      tipoDocumento: '01', // Valor predeterminado: Visado
      detalle: '',
      porcentaje: 0,
      monto: 0,
    });
  ...
  // Obtener opciones para Tipo de Documento de Otros Cargos
  const tiposDocumentoCargos = [
    ...
    { value: '08', label: '08 - Depósitos de Garantía' },
    { value: '09', label: '09 - Multas o Penalizaciones' },
    { value: '10', label: '10 - Intereses Moratorios' },
                ...
                <ProductSelectorModal
                  ...
                  onSelect={(product) => {
                    ...
                    if (currentLineIndex !== null) {
                      ...
                      setValue(`detalleServicio.${idx}.precioUnitarioCRC`, product.precioUnitario); // Campo oculto para almacenar el precio original en CRC
                                  ...
                                  <div className="flex flex-col space-y-2">
                                    ...
                                    {watch(`detalleServicio.${index}.tieneExoneracion`) && (
                                      <div className="space-y-3">
                                        ...
                                        <input
                                          type="hidden"
                                          name={`detalleServicio.${index}.exoneracion.porcentajeExoneracion`}
                                          value="100"
